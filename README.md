...
4. Rate limiting 10 API calls per min and uses the token bucket algorithm. So invoking the 2nd command above 10 times rapidly will start giving 429 errors.
...
7. There is a lot to be done for making this production ready off course. To start with it needs to be secured with SSL and so on. This is a very basic web app satisfying what was asked.
